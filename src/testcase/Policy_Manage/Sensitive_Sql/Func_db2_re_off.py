...
#              2.选择db2类型数据库，风险等级分别为高，中，低，极高，状态禁用
# 预期结果：
...
class DB2SqlReOff(unittest.TestCase):
    def setUp(self):
    ...
    def tearDown(self):
        ...
        sql_execute.db2_drop_table('db2', self.dbtable)
